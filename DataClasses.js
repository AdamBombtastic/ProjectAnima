...
module.exports = {
    ...
    UserObject : function(db) {
        module.exports.DataObject.call(this,db);
        this.type = module.exports.DataTypes.USER;
        ...
        this.Username = function(val=null) {
            return this._baseProp("username",val);
        }
        this.Password = function(val=null) {
            return this._baseProp("password",val);
        }
        this.DisplayName = function(val = null) {
            return this._baseProp("displayname",val);
        }
    ...
    SpiritOject : function(db) {
        module.exports.DataObject.call(this,db);
        this.type = module.exports.DataTypes.SPIRIT;
        this.data = {
            dtCreated : 0,
            hOwner : -1,
            name : "",
